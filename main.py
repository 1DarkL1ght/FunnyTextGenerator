...
def main(args_path: Path | str):
    ...
    training_config = TrainingConfig(
        ...
        beta_anneal_steps=float(args["beta_anneal_steps"]),
        beta_warmup_steps=float(args["beta_warmup_steps"]),
        # beta_max_base=float(args["beta_max_base"]),
        # beta_anneal_cycle_length=float(args["beta_anneal_cycle_length"]),
        # beta_anneal_ramp_ratio=float(args["beta_anneal_ramp_ratio"]),
        # beta_anneal_warmup_cycles=int(args["beta_anneal_warmup_cycles"]),
        fp16=bool(args["fp16"]),
        tsne=int(args["tsne"]),
        seed=int(args["seed"]),
